...
#define DALHAL_REACTIVE_CFG_CONSTVAR              (DALHAL_REACTIVE_FEATURE_NONE)
/* only a development test device, that is used when testing engine write only functionality */
