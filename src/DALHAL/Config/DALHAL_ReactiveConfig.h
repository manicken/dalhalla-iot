...
// REGO600
#define DALHAL_REACTIVE_CFG_REGO600               (DALHAL_REACTIVE_FEATURE_CYCLE_COMPLETE | DALHAL_REACTIVE_FEATURE_RW) /* TODO HIGH PRIORITY implement */
#define DALHAL_REACTIVE_CFG_REGO600_REGISTRY_ITEM (DALHAL_REACTIVE_FEATURE_VALUE_CHANGE) /* TODO HIGH PRIORITY implement */
// RF433
...
// Sensors
#define DALHAL_REACTIVE_CFG_DHT                   (DALHAL_REACTIVE_FEATURE_VALUE_CHANGE) /* TODO HIGH PRIORITY implement */
#define DALHAL_REACTIVE_CFG_ONE_WIRE_TEMP_GROUP   (DALHAL_REACTIVE_FEATURE_CYCLE_COMPLETE) /* TODO HIGH PRIORITY implement */
#define DALHAL_REACTIVE_CFG_ONE_WIRE_TEMP_BUS     (DALHAL_REACTIVE_FEATURE_CYCLE_COMPLETE) /* TODO HIGH PRIORITY implement */
#define DALHAL_REACTIVE_CFG_ONE_WIRE_TEMP_DEVICE  (DALHAL_REACTIVE_FEATURE_VALUE_CHANGE) /* TODO HIGH PRIORITY implement */
// Templates
