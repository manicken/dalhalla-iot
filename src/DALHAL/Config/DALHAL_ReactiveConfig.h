...
#define DALHAL_REACTIVE_FEATURE_VALUE_CHANGE   0x00000002
#define DALHAL_REACTIVE_FEATURE_STATE_CHANGE   0x00000004
...
#define DALHAL_REACTIVE_CFG_TEMPLATE              (DALHAL_REACTIVE_FEATURE_ALL)
...
#define REACTIVE_ENTRY_BEGIN(CLASS_NAME)         REACTIVE_ENTRY(CLASS_NAME, Begin)
...
#define REACTIVE_DECLARE_FEATURE_BEGIN()         DECLARE_REACTIVE_FEATURE(Begin)
