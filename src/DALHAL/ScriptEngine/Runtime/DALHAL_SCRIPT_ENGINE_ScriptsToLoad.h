...
#define DALHAL_SCRIPT_ENGINE_SCRIPTS_DIRECTORY   "scripts/"
#define DALHAL_SCRIPT_ENGINE_DEFAULT_SCRIPT_FILE "script.txt"
#define DALHAL_SCRIPT_ENGINE_SCRIPTS_LIST_FILE_PATH DALHAL_SCRIPT_ENGINE_SCRIPTS_DIRECTORY "list.txt"
#else
#define DALHAL_SCRIPT_ENGINE_SCRIPTS_DIRECTORY     "/scripts/"
#define DALHAL_SCRIPT_ENGINE_DEFAULT_SCRIPT_FILE "script.txt"
#define DALHAL_SCRIPT_ENGINE_SCRIPTS_LIST_FILE_PATH DALHAL_SCRIPT_ENGINE_SCRIPTS_DIRECTORY "list.txt"
