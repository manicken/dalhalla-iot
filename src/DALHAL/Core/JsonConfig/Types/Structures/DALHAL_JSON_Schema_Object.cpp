...
namespace DALHAL {
    ...
    namespace JsonSchema {
        ...
        void SchemaObject::SchemaToJson(const SchemaTypeBase& fieldSchema, StringBuilderStreamer& sbs, SchemaEmitMode mode) {
        ...
        const JsonObject SchemaObject::GetValidatedJsonObject(const JsonVariant& jsonObj) const {
            return jsonObj[this->name].as<JsonObject>();
        }
