...
// REGO600
#define DALHAL_REACTIVE_CFG_REGO600               (DALHAL_REACTIVE_FEATURE_CYCLE_COMPLETE | DALHAL_REACTIVE_FEATURE_RW | DALHAL_REACTIVE_FEATURE_BRACKET_WRITE) /* implemented */
