...
#define DALHAL_DEV_HOME_ASSISTANT_DD_CONFIG_TOPIC_FMT                    DALHAL_DEV_HOME_ASSISTANT_DD_CONFIG_TOPIC_HEAD "/%s/" DALHAL_DEV_HOME_ASSISTANT_DD_BASENAME "_%04X%08X/%s_%s/" DALHAL_DEV_HOME_ASSISTANT_DD_CONFIG_TOPIC_TAIL
