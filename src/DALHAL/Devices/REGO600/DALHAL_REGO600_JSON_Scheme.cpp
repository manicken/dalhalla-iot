...
namespace DALHAL {
    ...
    namespace JsonSchema {
        ...
        constexpr FieldHardwarePin rxpinField = {"rxpin", FieldFlag::Required, static_cast<uint8_t>(GPIO_manager::PinFunc::IN)};
        constexpr FieldHardwarePin txpinField = {"txpin", FieldFlag::Required, static_cast<uint8_t>(GPIO_manager::PinFunc::OUT)};

        constexpr FieldUInt requestDelayMsField = {"requestDelayMs", FieldFlag::Optional, 0, 0, 10};

        constexpr FieldArray itemsField = {"items", FieldFlag::Required, &REGO600_Register, EmptyPolicy::Error};
        ...
        constexpr JsonObjectScheme REGO600 = {
            "REGO600",
            fields,
            nullptr, // no modes
