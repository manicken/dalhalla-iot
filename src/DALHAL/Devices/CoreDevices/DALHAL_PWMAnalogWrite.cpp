...
namespace DALHAL {
    ...
    bool PWMAnalogWriteConfig::VerifyJSON(const JsonVariant &jsonObj) {
        if (IsUINT32(jsonObj, DALHAL_KEYNAME_PWM_CFG_FREQUENCY) == false) { GlobalLogger.Error(DALHAL_ERR_VALUE_TYPE(DALHAL_KEYNAME_PWM_CFG_FREQUENCY)); return false; }
        if (IsUINT32(jsonObj, DALHAL_KEYNAME_PWM_CFG_RESOLUTION) == false) { GlobalLogger.Error(DALHAL_ERR_VALUE_TYPE(DALHAL_KEYNAME_PWM_CFG_RESOLUTION)); return false; }
        return true;
    }
    ...
    PWMAnalogWriteConfig::PWMAnalogWriteConfig(const JsonVariant &jsonObj, const char* type) : Device(type) {
        ...
        PWMAnalogWriteConfig::frequency = GetAsUINT32(jsonObj, DALHAL_KEYNAME_PWM_CFG_FREQUENCY, 0);
        PWMAnalogWriteConfig::resolution = GetAsUINT32(jsonObj, DALHAL_KEYNAME_PWM_CFG_RESOLUTION, 0);
