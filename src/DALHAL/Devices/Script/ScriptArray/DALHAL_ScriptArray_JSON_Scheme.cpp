...
namespace DALHAL {
    ...
    namespace JsonSchema {
        ...
        constexpr FieldBool readonlyField = {"readonly", FieldFlag::Optional, false};

        constexpr FieldArrayPrimitive items = {"items", FieldFlag::Required, PrimitiveTypeFlags::AllowNumbers, EmptyPolicy::Error};
