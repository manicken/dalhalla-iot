...
namespace DALHAL {
    ...
    protected:
        ...
        REACTIVE_DECLARE_FEATURE_BEGIN(ScriptVariable_Reactive);
#endif
#if HAS_REACTIVE_CYCLE_COMPLETE(SCRIPT_VARIABLE)
        REACTIVE_DECLARE_CYCLE_COMPLETE(ScriptVariable_Reactive);
#endif
#if HAS_REACTIVE_VALUE_CHANGE(SCRIPT_VARIABLE)
        REACTIVE_DECLARE_FEATURE_VALUE_CHANGE(ScriptVariable_Reactive);
#endif
#if HAS_REACTIVE_STATE_CHANGE(SCRIPT_VARIABLE)
        REACTIVE_DECLARE_FEATURE_STATE_CHANGE(ScriptVariable_Reactive);
#endif
#if HAS_REACTIVE_READ(SCRIPT_VARIABLE)
        REACTIVE_DECLARE_FEATURE_READ(ScriptVariable_Reactive);
#endif
#if HAS_REACTIVE_WRITE(SCRIPT_VARIABLE)
        REACTIVE_DECLARE_FEATURE_WRITE(ScriptVariable_Reactive);
#endif
#if HAS_REACTIVE_EXEC(SCRIPT_VARIABLE)
        REACTIVE_DECLARE_FEATURE_EXEC(ScriptVariable_Reactive);
#endif
#if HAS_REACTIVE_BRACKET_READ(SCRIPT_VARIABLE)
        REACTIVE_DECLARE_FEATURE_BRACKET_READ(ScriptVariable_Reactive);
#endif
#if HAS_REACTIVE_BRACKET_WRITE(SCRIPT_VARIABLE)
        REACTIVE_DECLARE_FEATURE_BRACKET_WRITE(ScriptVariable_Reactive);
#endif
#if HAS_REACTIVE_TIMEOUT(SCRIPT_VARIABLE)
        REACTIVE_DECLARE_FEATURE_TIMEOUT(ScriptVariable_Reactive);
#endif
#if HAS_REACTIVE_WRITE_ERROR(SCRIPT_VARIABLE)
        REACTIVE_DECLARE_FEATURE_WRITE_ERROR(ScriptVariable_Reactive);
#endif
#if HAS_REACTIVE_READ_ERROR(SCRIPT_VARIABLE)
        REACTIVE_DECLARE_FEATURE_READ_ERROR(ScriptVariable_Reactive);
#endif
#if HAS_REACTIVE_EXEC_ERROR(SCRIPT_VARIABLE)
        REACTIVE_DECLARE_FEATURE_EXEC_ERROR(ScriptVariable_Reactive);
#endif
    public:
        DALHAL_DECLARE_REACTIVE_TABLE(ScriptVariable_Reactive);
