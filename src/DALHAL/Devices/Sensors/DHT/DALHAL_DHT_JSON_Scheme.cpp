...
namespace DALHAL {
    ...
    namespace JsonSchema {
        ...
        constexpr const FieldString modelField = {"model", FieldFlag::Required, DALHAL_TYPE_DHT_MODEL_DHT11, models, FieldString::AllowedValuesPolicy::IgnoreCase};
        ...
        constexpr JsonObjectScheme DHT = {
            "OneWireTempDevice",
            fields,
            nullptr, // no modes
