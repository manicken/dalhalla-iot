...
namespace DALHAL {
    ...
    class OneWireTempDevice;
    class OneWireTempDeviceAtRoot;
    ...
    namespace JsonSchema {
        ...
        namespace OneWireTempDevice {
            ...
            struct Extractors final {
                ...
                static void Apply(DALHAL::DeviceCreateContext& context, DALHAL::OneWireTempDevice* out);
            };
        ...
        namespace OneWireTempDeviceAtRoot {
            ...
            struct Extractors final {
                /** used by the device class */
                static void Apply(DALHAL::DeviceCreateContext& context, DALHAL::OneWireTempDeviceAtRoot* out);
            };
