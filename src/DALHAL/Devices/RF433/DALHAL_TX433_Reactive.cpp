...
namespace DALHAL {
    ...
    DALHAL_DEFINE_REACTIVE_TABLE(TX433_Reactive) = {
        ...
        DALHAL_REACTIVE_ENTRY(TX433_Reactive, Custom2),
        DALHAL_REACTIVE_ENTRY(TX433_Reactive, Custom3),
#endif
#if HAS_REACTIVE_BEGIN(TX433)
        REACTIVE_ENTRY_BEGIN(TX433_Reactive),
#endif
#if HAS_REACTIVE_CYCLE_COMPLETE(TX433)
        REACTIVE_ENTRY_CYCLE_COMPLETE(TX433_Reactive),
#endif
#if HAS_REACTIVE_VALUE_CHANGE(TX433)
        REACTIVE_ENTRY_VALUE_CHANGE(TX433_Reactive),
#endif
#if HAS_REACTIVE_STATE_CHANGE(TX433)
        REACTIVE_ENTRY_STATE_CHANGE(TX433_Reactive),
#endif
#if HAS_REACTIVE_READ(TX433)
        REACTIVE_ENTRY_READ(TX433_Reactive),
#endif
#if HAS_REACTIVE_WRITE(TX433)
        REACTIVE_ENTRY_WRITE(TX433_Reactive),
#endif
#if HAS_REACTIVE_EXEC(TX433)
        REACTIVE_ENTRY_EXEC(TX433_Reactive),
#endif
#if HAS_REACTIVE_BRACKET_READ(TX433)
        REACTIVE_ENTRY_BRACKET_READ(TX433_Reactive),
#endif
#if HAS_REACTIVE_BRACKET_WRITE(TX433)
        REACTIVE_ENTRY_BRACKET_WRITE(TX433_Reactive),
#endif
#if HAS_REACTIVE_TIMEOUT(TX433)
        REACTIVE_ENTRY_TIMEOUT(TX433_Reactive),
#endif
#if HAS_REACTIVE_WRITE_ERROR(TX433)
        REACTIVE_ENTRY_WRITE_ERROR(TX433_Reactive),
#endif
#if HAS_REACTIVE_READ_ERROR(TX433)
        REACTIVE_ENTRY_READ_ERROR(TX433_Reactive),
#endif
#if HAS_REACTIVE_EXEC_ERROR(TX433)
        REACTIVE_ENTRY_EXEC_ERROR(TX433_Reactive),
#endif
