...
namespace DALHAL {
    ...
    namespace JsonSchema {
        ...
        constexpr FieldString chField = {"ch", FieldFlag::Optional, "0", ids, FieldString::AllowedValuesPolicy::IgnoreCase};
        constexpr FieldString btnField = {"btn", FieldFlag::Optional, "0", ids, FieldString::AllowedValuesPolicy::IgnoreCase};
        ...
        constexpr JsonObjectScheme TX433_Unit_TypeAFC = {
            "TX433_Unit_TypeAFC",
            fields,
            nullptr, // no modes
