...
namespace HAL_JSON {
    ...
    bool REST_Cmd::VerifyJSON(const JsonVariant &jsonObj) {
    ...
    Device* REST_Cmd::Create(const JsonVariant &jsonObj, const char* type) {
    ...
    HAL_JSON::HALOperationResult REST_Cmd::exec() {
        int getCode = 0;
        HTTPClient client;
